    ...
    >
      <div className="flex flex-col items-center text-center py-6 space-y-6 animate-[fade-in_0.4s_ease-out]">
        ...
        <div className="relative flex items-center justify-center">
          <div className="w-28 h-28 rounded-full bg-[#FAD4D8]/60 flex items-center justify-center animate-pulse">
            <div className="w-20 h-20 rounded-full bg-[#800A1D] flex items-center justify-center text-white shadow-xl shadow-[#800A1D]/25 transition-transform hover:scale-105">
        ...
        <div className="w-full pt-4">
          <button
            ...
            className="w-full h-13.5 rounded-full bg-[#800A1D] hover:bg-[#660817] text-white font-bold text-sm sm:text-base flex items-center justify-center transition-all shadow-md active:scale-[0.99] cursor-pointer"
          >
            Login
          </button>
        </div>
