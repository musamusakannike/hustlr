      ...
      >
        ...
        {submitted ? (
          ...
          <button
            ...
            className="w-full py-3 bg-neutral-100 hover:bg-neutral-200 text-text font-semibold text-sm rounded-xl transition-all duration-200 flex items-center justify-center gap-2.5 cursor-pointer"
          >
