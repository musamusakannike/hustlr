...
export default function MarketingFooter() {
  return (
    <footer className="bg-light text-black pt-20 sm:pt-24 pb-12 px-6 sm:px-12 lg:px-16 xl:px-20 font-space-grotesk border-t border-black/10">
      <div className="max-w-7xl mx-auto flex flex-col gap-8 sm:gap-10">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-center justify-between gap-6 md:gap-8">
          ...
          <nav className="flex flex-wrap items-center justify-center gap-6 sm:gap-8 md:gap-10 text-sm sm:text-base font-medium text-black/60">
